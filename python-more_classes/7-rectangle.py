#!/usr/bin/python3
"""
Module for a Rectangle class with a customizable print symbol.
"""
...
class Rectangle:
    ...
    def __str__(self):
        ...
        if self.__width == 0 or self.__height == 0:
            return ""
        # We use str(self.print_symbol) to handle cases where 
        # print_symbol is not a string (like a list)
